...
<body>
    ...
    <section class="pro">
        <div class="Podpiska">
            ...
            <div class="hh2">
                <div class="Phot">
                    <img class="One" src="./image/ybic.svg" width="150px" height="200px">
                    ...
                    <img class="Four" src="./image/9.svg"  width="82px" height="120px">
                </div>
                <div class="FTR">
                    <p>более 100</p>
                </div>
        ...
        <div class="FRR">
            <?php
                ...
                $sql = "SELECT poster_url, duration, rating, subscription_type, title
                    FROM `movies` WHERE id IN (4,5,6,16,17,19,20,18,22,23)
                    LIMIT 10";
            $result = $conn->query($sql);
